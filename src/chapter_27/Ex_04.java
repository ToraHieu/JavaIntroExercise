...
public class Ex_04 {
    public static void main(String[] args) {
        // Create a map
        Ex04HashMap<String, Integer> map = new Ex04HashMap<>();
        map.put("Smith", 30);
        map.put("Anderson", 31);
        map.put("Lewis", 29);
        map.put("Cook", 29);
        ...
        System.out.println("All value of key \"Anderson\": " + map.getAll("Anderson"));
    }
}

class Ex04HashMap<K, V> implements MyMap<K, V> {
     ...
     * default load factor */
    public Ex04HashMap(int initialCapacity) {
        this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);
    }

    /** Construct a map with the specified initial capacity
     * and load factor */
    public Ex04HashMap(int initialCapacity, float loadFactorThreshold) {
