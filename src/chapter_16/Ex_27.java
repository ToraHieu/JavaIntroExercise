...
public class Ex_27 extends Application {
    ...
    public void start(Stage primaryStage) {
       ...
       flagDescription = setTextDescriptions(flagDescription);
    ...
    /** Set the description from files */
    private String[] setTextDescriptions(String[] descriptions) {
        for (int i = 0; i < descriptions.length; i++) {
            try {
                Scanner scanner = new Scanner(new File("text/description" + i + ".txt"));
