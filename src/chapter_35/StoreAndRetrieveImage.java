...
public class StoreAndRetrieveImage extends Application {
    ...
    private chapter_16.DescriptionPane descriptionPane
            = new chapter_16.DescriptionPane();
    ...
    private void storeDataToTable() {
        ...
        String[] imageFilenames = {"src/image/ca.gif", "src/image/uk.gif",
                "src/image/us.gif", "src/image/germany.gif", "src/image/india.gif",
                "src/image/china.gif"};
        ...
        try {
            ...
            for (int i = 0; i < countries.length; i++) {
                ...
                InputStream inputImage = new FileInputStream(imageFilenames[i]);
