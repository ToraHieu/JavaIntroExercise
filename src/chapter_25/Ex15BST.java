...
public class Ex15BST<E extends Comparable<E>> implements Tree<E> {
    ...
    protected TreeNode<E> createNewNode(E e, TreeNode<E> p) {
        return new TreeNode<>(e, p);
    }

    /** Return the node the specified element.
