...
/** Copied from the solution with additional notes*/
public class Ex_32 extends Application {
     ...
     * The approach is good (not that I fully understand it anyway), just the naming may cause confusing.
     */
