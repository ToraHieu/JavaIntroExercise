...
public class Ex_15 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        weightTf.setText("");
        startTf.setTextFormatter(getNewFormatter());
        startTf.setText("");
        endTf.setTextFormatter(getNewFormatter());
        endTf.setText("");
        ...
        gridPane.add(new Text("Find a shortest path"), 4, 0, 2, 1);
        gridPane.addColumn(4, new Text("Starting vertex:"),
                new Text("Ending vertex:"));
        gridPane.addColumn(5, startTf, endTf, shortestPathBtn);
        ...
        shortestPathBtn.setOnMouseClicked(event -> {
            int start = Integer.parseInt(startTf.getText());
            int end = Integer.parseInt(endTf.getText());
            view.highlightPath(getPathIndex(graph.getShortestPath(start).getPath(end), graph.getVertices()));
        });
