...
@SuppressWarnings({"DanglingJavadoc", "unchecked", "ExplicitArrayFilling", "Convert2Diamond", "ForLoopReplaceableByForEach"})
public class UnweightedGraph<V> implements Graph<V> {
    ...
    public Ex25UnweightedGraph<V>.SearchTree dfs(int v) {
