...
class CarPane extends Pane {
    ...
    private final Circle c1 = new Circle(baseX + 10 + 5, baseY - 10 + 5, 5);
    private final Circle c2 = new Circle(baseX + 30 + 5, baseY - 10 + 5, 5);

    private final Rectangle carBody = new Rectangle(baseX, baseY - 20, 50, 10);
    private final Polygon carTop = new Polygon(baseX + 10, baseY - 20,
