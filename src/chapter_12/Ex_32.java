...
/** Copied from solution file. Yes, I'm a shame */
public class Ex_32 {
    ...
    public static void readNames() {
       for (int i = 0; i < 10; i++) {
        String filename;
        if (i == 9)
          filename = "D:/DH16LT/Java/Excercise12/babynamesranking2010.txt";
        else
          filename = "D:/DH16LT/Java/Excercise12/babynamesranking200" + (i + 1) + ".txt";
